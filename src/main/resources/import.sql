...
INSERT INTO receipts (store_id, pos_system_id, user_id, till_id, cashier_id, promotion_id, transaction_date, subtotal, vat_rate, vat_amount, discount_amount, total_due_after_tax, amount_paid, change_due, viewed)
