...
INSERT INTO cashiers (name, surname) VALUES
                                         ('John', 'Zungu'),
                                         ('Jane', 'Dlomo');

INSERT INTO tills (store_id, pos_system_id, till_number) VALUES
                                                             (1, 1, 'Till_No_1'),
                                                             (2, 2, 'Till_No_2');

INSERT INTO promotions (name, description, start_date, end_date, discount) VALUES
                                                                               ('Black Friday', 'Get 10% off on selected items', '2023-01-01', '2023-12-31', 10.00),
